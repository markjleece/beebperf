...
|---|---|
| [docs\BeebPerf.docx](docs\BeebPerf.docx) | Provides details on BeebPerf, which may be of interest |

# Credits
Portions of the display reconstruction code were copied from BeebEm's video class, specifically the Mode 7 font, font loading, font initialization code, and state machine code.
