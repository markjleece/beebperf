...
If the installer reports error S1023, the most likely cause is that newer Microsoft Visual C++ 2010 redistributables are installed on the system. The fix is to temporarily uninstall the newer VC++ 2010 x86/x64 redistributables, and then reinstall the DirectX SDK.
